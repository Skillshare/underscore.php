...
class __ {
  ...
  protected static $__parent;
  protected static $__parents = [];

  public function __construct() {
    $this->base_id = self::$counter++;
    self::$__parents[$this->base_id] = new Underscore();
  }

  public static function init() {
    if (!isset(self::$__parent)) {
      self::$__parent = Underscore::getInstance();
    }
    return;
  }
  ...
  public function __set($key, $value) {
    if ($key == '_wrapped') {
      self::$__parents[$this->base_id]->_wrapped = $value;
      return $value;
    }
  }
  ...
  public function __get($key) {
    if ($key == '_wrapped') {
      return self::$__parents[$this->base_id]->_wrapped;
    }
  }
  ...
  public function __call($method, $args) {
    ...
    if ($method == 'chain') {
      ...
      return call_user_func_array([$__, $method], $args);
    }
  }

  public static function __callStatic($method, $args) {
    self::init();
    return call_user_func_array([self::$__parent, $method], $args);
  }
}
